...
const getWeather = (latLon, callback)=>{
    ...
    request({url, json:true}, (e, {body}={})=>{
        try{
            ...
            const response = `It´s ${weather_descriptions[0]} in ${locationName} ${country} at around ${temperature} and the chance of rain is ${precip}. This was measured at ${localtime} at a humidity of ${humidity}% and wind speeds up to ${wind_speed} km/h`
